...
You can also use `Ash.Scope` to you can group up actor/tenant/context into one struct and pass that around. This is useful for setting tenant context globally:
